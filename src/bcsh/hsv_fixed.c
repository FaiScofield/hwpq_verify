...
/* sin(2*pi*k/256) 的 Q15 表（k = 0..256，末项为 360°，用于 wrap 处插值；1.0 = 32768）。
   domain 无关量：RGB 域绕灰轴旋转（rgb_adjust.h）与 YCbCr 域极角旋转（yuv_adjust.c）
   共用；查询接口 adj_sin_q15/adj_cos_q15 见 hsv_fixed.h。 */
const int16_t g_adj_sin_q15[257] = {0, 804, 1608, 2411, 3212, 4011, 4808, 5602, 6393, 7180, 7962, 8740, 9512,

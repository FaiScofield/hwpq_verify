...
/* 绕灰轴旋转用的 sin/cos 插值表（g_adj_sin_q15 与 adj_sin_q15/adj_cos_q15）
   为 domain 无关量，已移至 hsv_fixed.h/.c，与 YCbCr 极角旋转共用。 */
...
{
    const int32_t cs = adj_cos_q15(angle_q14);
    const int32_t sn = adj_sin_q15(angle_q14);

#ifndef VDPP_RK3576_H
#define VDPP_RK3576_H

// 0x00000000
typedef union iep2_rk3576 {
    struct {
...
typedef union vep_rk3576 {
    ...
    unsigned int data[61];
} vep_rk3576_u;

// 0x00001100
typedef union es_rk3576 {
    struct {
    ...
    struct {
        union { // name: ctrl, offset: 0x0
            struct {
                ...
                unsigned int sw_coloradj_bypass_en  : 1;
        ...
        union { // name: coloradj_ctrl0, offset: 0x230
            struct {
                unsigned int sw_adj_point_x0      : 8;
                unsigned int reserve_0            : 4;
                unsigned int sw_adj_point_y0      : 8;
                unsigned int reserve_1            : 4;
        ...
        union { // name: coloradj_ctrl4, offset: 0x240
            struct {
                unsigned int sw_adj_point_x1      : 8;
                unsigned int reserve_0            : 4;
                unsigned int sw_adj_point_y1      : 8;
                unsigned int reserve_1            : 4;
        ...
        union { // name: coloradj_ctrl8, offset: 0x250
            struct {
                unsigned int sw_adj_point_x2      : 8;
                unsigned int reserve_0            : 4;
                unsigned int sw_adj_point_y2      : 8;
                unsigned int reserve_1            : 4;
        ...
        union { // name: coloradj_ctrl12, offset: 0x260
            struct {
                unsigned int sw_adj_point_x3      : 8;
                unsigned int reserve_0            : 4;
                unsigned int sw_adj_point_y3      : 8;
                unsigned int reserve_1            : 4;

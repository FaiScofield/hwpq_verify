    ...
    struct {
        ...
        union { // name: sys_axi_hurry_ctrl0_imd, offset: 0x14
            struct {
                ...
                unsigned int axi0_port1_urgency_en : 1;
                unsigned int axi0_port2_urgency_en : 1;
        ...
        union { // name: sys_port_ctrl_imd, offset: 0x28
            struct {
                ...
                unsigned int vp_intr_merge_en           : 1;
                unsigned int reserve_3                  : 1;
                unsigned int write_mask                 : 16;
            } bits;
            unsigned int val;
        ...
        union { // name: fbcd_timeout_ctrl, offset: 0x48
            struct {
...
// 0x27d00500
typedef union overlay_system_rk3576 {
    struct {
...
} overlay_system_rk3576_u;

// 0x27d00600
typedef union overlay_port0_rk3576 {
    struct {
...
} overlay_port0_rk3576_u;

// 0x27d00700
typedef union overlay_port1_rk3576 {
    struct {
        union { // name: overlay_ctrl, offset: 0x0
            struct {
                unsigned int overlay_mode : 1;
    ...
    unsigned int data[29];
} overlay_port1_rk3576_u;

// 0x27d00800
typedef union overlay_port2_rk3576 {
    struct {
        union { // name: overlay_ctrl, offset: 0x0
            struct {
                unsigned int overlay_mode : 1;
    ...
    unsigned int data[29];
} overlay_port2_rk3576_u;

// 0x27d00c00
typedef union post0_ctrl_rk3576 {
    struct {
        ...
        union { // name: post_color_ctrl, offset: 0x8
            struct {
                ...
                unsigned int reserve_1      : 2;
                unsigned int sw_urgency_en  : 1;
                unsigned int reserve_2      : 7;
                unsigned int sw_urgency_thl : 4;
                unsigned int sw_urgency_thh : 4;
                unsigned int reserve_3      : 8;
            } bits;
            unsigned int val;
        } post_color_ctrl;
        ...
        union { // name: post_check_value, offset: 0x24
            struct {
                unsigned int post_crc_check_value : 32;
            } bits;
            unsigned int val;
        } post_check_value;
        union { // name: post_crc_value, offset: 0x28
            struct {
                unsigned int post_crc_value : 32;
            } bits;
            unsigned int val;
        } post_crc_value;
        ...
        union { // name: post_scl_ctrl, offset: 0x40
            struct {
                ...
                unsigned int reserve_1              : 1;
                unsigned int post_crc_en            : 1;
                unsigned int post_crc_check_en      : 1;
                unsigned int reserve_2              : 22;
            } bits;
            unsigned int val;
        } post_scl_ctrl;
    ...
    unsigned int data[62];
} post0_ctrl_rk3576_u;

// 0x27d00d00
typedef union post1_ctrl_rk3576 {
    struct {
        union { // name: post_dsp_ctrl, offset: 0x0
            struct {
                unsigned int dsp_out_mode          : 4;
        ...
        union { // name: post_mcu_rw_bypass, offset: 0xfc
            struct {
                unsigned int mcu_bypass_wdata : 24;
                unsigned int reserve_0        : 8;
            } bits;
            unsigned int val;
        } post_mcu_rw_bypass;
...
// 0x27d00e00
typedef union post2_ctrl_rk3576 {
    struct {
        union { // name: post_dsp_ctrl, offset: 0x0
            struct {
                unsigned int dsp_out_mode          : 4;
...
typedef union cluster0_rk3576 {
    struct {
        ...
        union { // name: win0_cbcr_mst, offset: 0x14
            struct {
        ...
        union { // name: win0_key_color, offset: 0x1c
            struct {
        ...
        union { // name: win1_ctrl2, offset: 0x88
            struct {
                unsigned int win1_rid_yrgb : 5;
                unsigned int win1_rid_cbr  : 5;
                unsigned int reserve_0     : 22;
            } bits;
            unsigned int val;
        } win1_ctrl2;
        ...
        union { // name: win1_cbcr_mst, offset: 0x94
            struct {
        ...
        union { // name: win1_key_color, offset: 0x9c
            struct {
        ...
        union { // name: cluster_ctrl, offset: 0x100
            struct {
                ...
                unsigned int clusrer_dma_stride_4k       : 1;
                unsigned int reserve_5                   : 1;
    ...
    struct {
        union { // name: esmart_ctrl0, offset: 0x0
            struct {
                ...
                unsigned int reserve_3               : 7;
                unsigned int esmart_csc_out_path_sel : 1;
...
// 0x27d02000
typedef union hdr_vivid_rk3576 {
    struct {
...
// 0x27d05000
typedef union gamma_lut_wraddr_rk3576 {
    struct {
    } regs;
    unsigned int data[0];
} gamma_lut_wraddr_rk3576_u;

// 0x27d06000
typedef union bpp_lut_wraddr_rk3576 {
    struct {
    } regs;
    unsigned int data[0];
} bpp_lut_wraddr_rk3576_u;

// 0x27d06400
typedef union acm_rk3576 {
    struct {

...
struct common_verify_cmd_config
{
    ...
    char crc_file[1024];
    char other_args[1024]; // other arguments, parsed by some modules independently
    char platform[32];     // RK3576/RK3572/...
...
int common_verify_arg_get_cmd_config(int argc, char *argv[], struct common_verify_cmd_config *config, bool bSetDefault);

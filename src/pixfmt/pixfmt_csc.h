...
#ifndef _PIXFMT_CSC_H_
#define _PIXFMT_CSC_H_
...
static inline bool pixfmt_colorspcae_check_same(pixfmt_colorspcae_e clrspc0, pixfmt_colorspcae_e clrspc1)
{
    return clrspc0 != PIXFMT_CLRSPC_UNKNOWN && clrspc1 != PIXFMT_CLRSPC_UNKNOWN && (clrspc0 & 0xE) == (clrspc1 & 0xE);
}
static inline bool pixfmt_colorspcae_is_fullrange(pixfmt_colorspcae_e clrspc)
{
    return clrspc != PIXFMT_CLRSPC_UNKNOWN && (clrspc & 0x1) == 1;
}
static inline bool pixfmt_colorspcae_is_limitrange(pixfmt_colorspcae_e clrspc)
{
    return clrspc != PIXFMT_CLRSPC_UNKNOWN && (clrspc & 0x1) == 0;
}

#endif /* _PIXFMT_CSC_H_ */
